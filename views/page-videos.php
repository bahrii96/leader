...
get_header();
$page_videos = get_field('page_videos');


if ($page_videos) {
	$hero_group = $page_videos['hero_group'];
	$popular_group = $page_videos['popular_group'];
};
?>
<main>
	<?php if ($hero_group) :
	...
	<section class="post-block">
		<div class="container">
			<div class="post-block-categories ">
				<h2 data-aos="fade-up"><?php _e('Our Videos', 'your-theme-textdomain'); ?></h2>
				<ul class="desktop-categories" data-aos="fade-up">
					...
					$terms = get_terms([
						...
						'orderby'    => 'count', // Сортування за кількістю постів
						'order'      => 'DESC',  // Від найбільшої кількості до найменшої
						'hide_empty' => false,
						'post_type' => 'videos',
					]);
			...
			<div class="filter-box">
				...
				<div class="video-filter" data-aos="fade-up">
					<select id="video-type-select">
						<option value="all"><?php _e('All Videos', 'your-theme-textdomain'); ?></option>
						<option value="free-content"><?php _e('Free Videos', 'your-theme-textdomain'); ?></option>
					</select>
				</div>
			</div>

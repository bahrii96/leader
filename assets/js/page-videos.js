    ...
    $(document).ready(function () {
        ...
        function loadVideosByCategory(categoryId) {
            $.ajax({
                ...
                data: {
                    action: 'load_videos_by_category',
        ...
        var swiper = new Swiper('.popular__swiper-video', {
            slidesPerView: 1.2,
            spaceBetween: 8,
            breakpoints: {
                9778: {
        ...
        var swiper = new Swiper('.popular__swiper-video-more', {
            slidesPerView: 1.2,
            spaceBetween: 8,
            breakpoints: {
                9778: {
            ...
            speed: 1000,
			     ...
			     $('#presenter-select').on('change', function () {
                     ...
                     $.ajax({
                         ...
                         data: {
                             action: 'filter_videos_by_presenter',
